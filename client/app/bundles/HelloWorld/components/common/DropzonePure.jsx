...
export default class DropzonePure extends React.Component {
  constructor(props) {
    super(props)
    this.state = { isDragActive: false }

    _.bindAll(this, 'onDragEnter', 'onDragLeave', 'onDrop', 'onClick');
  }
...
DropzonePure.defaultProps = {
  disableClick: false,
  multiple: true
}

DropzonePure.propTypes = {
